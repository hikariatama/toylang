...
export const TYPES = new Set(["Integer", "Real", "Boolean", "String", "Map"]);
export const BUILTINS = new Set(["IO", "Time", "Screen", "Math"]);
export const defaultCode = `class FileSystem is
